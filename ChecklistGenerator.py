...
bag1 = xToolList.tree.push(Item("bag 1"))
bag1.push(Item("hardware", "1/4"))
bag1.push(Item("Door Pulls", "Pl"))


bag2 = xToolList.tree.push(Item("bag 2"))
carbonFilter = bag1.push(Item("Carbon Filter"))
carbonFilter.push(Item("fan", "12V"))


bag3 = xToolList.tree.push(Item("bag 3"))
